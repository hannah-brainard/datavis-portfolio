...
| Provide details on aternatives, where to look for information |  Show top Carbon 200 Underground indexes, juxtaposed with top sustainable indexes. This can be visualized in a dot plot, identified by color. Labels will identify names of index, so user can find more information independently. Additionally, in the call to action, I will add link buttons to learn more.  |                                                                                |
